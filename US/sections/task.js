...
function showReputation(face){
    var reputation = {
        type: "html-keyboard-response",
        stimulus: "<img src=\'img/faces/"+face['image']+"\'>",
        prompt: "<h2 style=\"text-align: center;\">" + face['exact value'] + "% of people said that this player is competent.</h2><div style=\"height:186px; color:white\"></div>",
        choices: [],
...
function showTrialQ(face){
    ...
    var q = {
        type: 'survey-multi-choice',
        button_label: button_str,
        preamble: "<img src=\'img/faces/"+face['image']+"\'> <h2 style=\"text-align: center;\">" + face['exact value'] + "% of people said that this player is competent.</h2>",
        questions: [{
            prompt: "<h2 style=\"text-align: center;\">How much money will you give to this player?</h2>",
            options: money_option,
            horizontal: true,
...
function showTraitQ(face){
    var q = {
        ...
        button_label: button_str,
        preamble: "<img src=\'img/faces/"+face['image']+"\'> <h3 style=\"text-align: center;\">" + face['exact value'] + "% of people said that this player is competent.</h3>",
        questions: [{
