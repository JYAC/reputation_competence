...
var instru3b = {
    ...
    '<p>You will now play this game with 72 different players. We will let you know periodically how far along you are in the games. <u>In addition to seeing Player 2’s avatar, you will also see the percentage of people who rated this person as competent. These competence ratings come from participants in previous studies who interacted with these players on a variety of joint tasks.</u></p>'+
...
var instru5 = {
    ...
    allow_backward: false,
    pages: [
    '<p>You have finished the first portion of the study. Please click on the link below and complete the questionnaire. In the questionnaire, we will show you half of the players with whom you played, and ask you to rate them along various characteristics. You may close both tabs after you complete the questionnaire.</p> <p><b><a href="https://stanforduniversity.qualtrics.com/jfe/form/SV_2snFahDXtwGEdj7">https://stanforduniversity.qualtrics.com/jfe/form/SV_2snFahDXtwGEdj7</a></b></p>']
}
