...
var instru3b = {
    ...
    pages:[
    '<p>您完成了12局遊戲練習。</p>'+
    '<p>您現在會跟72位不同的玩家玩這個遊戲。我們會定期地顯示您在遊戲中的進展。<u>在看到玩家2的頭像之外，您也會看到一個百分比數字，代表多少人認為他是值得信賴的。這些信任指數來自之前的研究參與者。他們跟玩家2在一系列項目上合作過。</u></p>'+
    '<p>就像您之前所練習的12局遊戲一樣，您會選擇給玩家2轉發的金額。然後，玩家2會收到您轉發的錢，將決定把其中多少還給您。當您等待對方的決定時，您將繼續完成研究的其他部分。</p>'+
    '<p>在實驗的最後，我們會隨機抽選72局的其中一局，給你和玩家2你們在那局最終擁有的錢。你總共的收益從而是150元的禮物卡加上那隨機抽取的一局的錢。請不要讓自己在任何一局作出的決定影響你在其他的局做出的決定。</p>'+
...
var instru5 = {
    ...
    allow_backward: false,
    pages: [
    '<p>你已完成了實驗的第一部分。請點擊以下的網絡連結，完成問卷。在這個問卷中，我們會顯示一些跟您互動過的玩家，並讓您對他們的一些性格特點評分。完成問卷之後，你可以把兩個網頁都關掉。</p> <p><b><a href="https://stanforduniversity.qualtrics.com/jfe/form/SV_230XvRwKTrPWMHb">https://stanforduniversity.qualtrics.com/jfe/form/SV_230XvRwKTrPWMHb</a></b></p>']
}
